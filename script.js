 ...
 grabFAV=()=> {
    ...
    var duckapi = "https://icons.duckduckgo.com/ip3/"; //duck duckgo api
    var gapi = "https://s2.googleusercontent.com/s2/favicons?domain="; //google api
    if (mysize == "default") 
    {
        var h1 = "https://";
        var h2 = "http://";
